...
public class UnitListButtonDestroyer : MonoBehaviour
{
    ...
    /// </summary>
    public void AddUnitListButtonToDestroy(UnitListButton unitListButton)
    {
    ...
    IEnumerator DestroyAUnitListButton()
    {
        ...
        UnitListButton unitListButtonToDestroy = unitListButtonsToDestroy[0];
