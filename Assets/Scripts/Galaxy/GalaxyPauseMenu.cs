...
public class GalaxyPauseMenu : MonoBehaviour
{
    ...
    private bool ShouldCloseDueToEscape
    {
        get
        {
            return Input.GetKeyDown(KeyCode.Escape) && !GalaxyConfirmationPopupBehaviour.isAConfirmationPopupOpen && (!GalaxySettingsMenu.closedOnFrame && !settingsMenu.gameObject.activeInHierarchy);
        }
    }
