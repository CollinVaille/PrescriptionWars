// Upgrade NOTE: upgraded instancing buffer 'ExoPlanetsLegacyPlanetForSky' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Exo-Planets/Legacy/PlanetForSky"
{
	Properties
	{
		...
		_SkyblendA("Sky Blend (A)", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(ExoPlanetsLegacyPlanetForSky)
			UNITY_DEFINE_INSTANCED_PROP(float4, _PolarMask_ST)
#define _PolarMask_ST_arr ExoPlanetsLegacyPlanetForSky
			UNITY_DEFINE_INSTANCED_PROP(float3, _LightSource)
#define _LightSource_arr ExoPlanetsLegacyPlanetForSky
		UNITY_INSTANCING_BUFFER_END(ExoPlanetsLegacyPlanetForSky)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv_ColorTexture144 = i.uv_texcoord;
			...
			float2 uv_NecessaryWaterMask331 = i.uv_texcoord;
			...
			float2 uv_TexCoord325 = i.uv_texcoord + appendResult152;
			float temp_output_371_0 = ( _CloudSpeed / 80.0 );
			float4 appendResult317 = (float4(temp_output_371_0 , 0.0 , 0.0 , 0.0));
			float4 UVcloudShadows194 = ( float4( uv_TexCoord325, 0.0 , 0.0 ) + ( appendResult317 * _Time.x ) );
			...
			float2 uv_PolarMask = i.uv_texcoord * _PolarMask_ST_Instance.xy + _PolarMask_ST_Instance.zw;
			...
			float4 UVClouds308 = ( float4( i.uv_texcoord, 0.0 , 0.0 ) + ( appendResult330 * _Time.x ) );
			...
			float3 lerpResult300 = lerp( UnpackScaleNormal( tex2D( _Normals, i.uv_texcoord ), ( (0.0 + (_NormalsIntensity - 0.0) * (1.0 - 0.0) / (2.0 - 0.0)) * 0.25 ) ) , FlatNormal217 , ContinentalMasks248);
			...
			float dotResult239 = dot( normalize( (WorldNormalVector( i , Normals229 )) ) , LightSourceVector398 );
			...
			float4 temp_cast_9 = (temp_output_353_0).xxxx;
			float4 lerpResult347 = lerp( lerpResult303 , temp_cast_9 , temp_output_353_0);
			float4 NightDayMask233 = lerpResult347;
			float4 temp_cast_10 = (0.0).xxxx;
			float2 temp_cast_11 = (_CitiesDetail).xx;
			float2 uv_TexCoord333 = i.uv_texcoord * temp_cast_11;
			...
			float4 Cities130 = (( _EnableCities )?( ( ( float4( ( ( ( ( ( tex2D( _CitiesTexture, uv_TexCoord333 ).r * ( 1.0 - tex2D( _CitiesTexture, i.uv_texcoord ).a ) ) * ( 1.0 - clampResult148 ) ) * clampResult314 ) * pow( saferPower122 , 4.0 ) ) * CloudsOcclusion368 ) , 0.0 ) * _Citiescolor ) * 1.0 ) ):( temp_cast_10 ));
			...
			float fresnelNdotV342 = dot( normalize( ase_normWorldNormal ), ase_worldViewDir );
			...
			float3 temp_cast_16 = (fresnelNode342).xxx;
			float3 linearToGamma264 = LinearToGammaSpace( temp_cast_16 );
			float4 BaseColorAtmospheres407 = _AtmosphereColor;
			float dotResult395 = dot( LightSourceVector398 , ase_normWorldNormal );
			...
			float3 temp_cast_22 = (( pow( saferPower137 , ( lerpResult273 * (0.0 + (0.5 - 0.0) * (1.0 - 0.0) / (30.0 - 0.0)) ) ) * 0.5 )).xxx;
			float3 gammaToLinear118 = GammaToLinearSpace( temp_cast_22 );
			...
			o.Emission = SecondPassInput211.rgb;
			o.Alpha = CalculateContrast(1.0,NightDayMask233).r;
		}
...
/*ASEBEGIN
Version=17700
-1680;203;1680;989;-1305.988;3429.262;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;370;-839.709,-197.6685;Float;False;Property;_CloudSpeed;Cloud Speed;7;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;272;-4472.489,-286.4043;Float;False;Property;_ColorA;Color + A;6;1;[HDR];Create;True;0;0;False;0;4.541205,4.541205,4.541205,0.3607843;4.541205,4.541205,4.541205,0.4156863;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;351;400.1611,2114.263;Float;False;Property;_ReliefIntensity;ReliefIntensity;32;0;Create;True;0;0;False;0;2.001;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;136;537.5205,2319.059;Float;False;Property;_ReliefSmoothness;Relief Smoothness;34;0;Create;True;0;0;False;0;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;184;1134.411,2457.841;Inherit;True;Property;_Normals;Normals;25;0;Create;True;0;0;False;0;-1;None;1907237ddf9d1cf4bb68e66ec44f0787;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;401;-5594.039,-2361.09;Float;False;InstancedProperty;_LightSource;_LightSource;20;0;Create;True;0;0;False;0;1,0,0;18.7,89.7,-49.5;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;241;-4408.349,253.9805;Float;False;Property;_IlluminationAmbient;Illumination Ambient;19;0;Create;True;0;0;False;0;0.09019608,0.06666667,0.1490196,0;0.2664913,0.1903509,0.434,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;345;-852.5586,611.8774;Float;False;Property;_ShadowsYOffset;Shadows Y Offset;8;0;Create;True;0;0;False;0;-0.005;-0.005;-0.02;0.02;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;157;-5191.229,-16.20459;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;338;-857.0889,506.4224;Float;False;Property;_ShadowsXOffset;Shadows X Offset;9;0;Create;True;0;0;False;0;-0.005;-0.005;-0.02;0.02;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;144;-4473.879,-1048.448;Inherit;True;Property;_ColorTexture;Color Texture;0;1;[NoScaleOffset];Create;True;0;0;False;0;-1;None;41af227b5b9ec55429317fa5ceb01a1d;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;361;-3365.899,1092.86;Float;False;Property;_CitiesDetail;Cities Detail;21;0;Create;True;0;0;False;0;4;6.1;1;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;147;-4427.489,-670.9463;Float;False;Property;_WaterColor;Water Color;23;0;Create;True;0;0;False;0;0.282353,0.4431373,0.5176471,0;0.144704,0.227696,0.266,0.1803922;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;364;-3330.199,595.4204;Float;False;Property;_ShadowsSharpness;Shadows Sharpness;10;0;Create;True;0;0;False;0;2.5;2.58;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;320;-2771.079,1083.113;Inherit;True;Property;_CitiesTexture;Cities Texture;5;0;Create;False;0;0;False;0;-1;None;None;True;0;False;black;Auto;False;Object;-1;MipLevel;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;365;-3241.849,-730.0474;Float;False;Property;_InteriorSize;Interior Size;14;0;Create;True;0;0;False;0;0.3;1.12;-2;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;363;-2394.239,-686.6113;Float;False;Property;_InteriorIntensity;Interior Intensity;17;0;Create;True;0;0;False;0;0.65;0.65;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;408;-4408.039,-7.570313;Float;False;Property;_AtmosphereColor;Atmosphere Color;13;1;[HDR];Create;True;0;0;False;0;0.3764706,1.027451,1.498039,0;0.3843136,1.140504,1.498039,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;278;-1220.349,1236.647;Float;False;Property;_Citiescolor;Cities color;12;1;[HDR];Create;True;0;0;False;0;7.906699,2.649365,1.200494,0;84.33185,17.87464,110.1309,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;234;-2581.689,-3298.984;Float;False;Property;_ShadowColorA;Shadow Color + A;30;0;Create;True;0;0;False;0;0.09803922,0.2313726,0.4117647,1;0.09803919,0.2313726,0.4117647,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;420;601.9456,-3689.359;Inherit;False;Property;_SkyblendA;Sky Blend (A);36;0;Create;False;0;0;False;0;0,0,0,0;0.491436,0.5812334,0.748,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;162;614.8711,-3271.404;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;421;911.2239,-3626.042;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;95;2069.631,-3188.124;Inherit;False;746.2273;389.1991;Comment;2;236;424;Second shader pass output;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;424;2085.902,-2896.866;Inherit;False;233;NightDayMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;211;1243.233,-3275.971;Float;False;SecondPassInput;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;236;2161.037,-3006.014;Inherit;False;211;SecondPassInput;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;423;2221.844,-3086.108;Inherit;False;Constant;_Float15;Float 15;37;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleContrastOpNode;425;2305.988,-2746.262;Inherit;False;2;1;COLOR;0,0,0,0;False;0;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;422;2536.665,-3094.338;Float;False;True;-1;2;PlanetEditor;0;0;StandardSpecular;Exo-Planets/Legacy/PlanetForSky;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;422;2;236;0
WireConnection;422;9;425;0
ASEEND*/
//CHKSM=C966072765513B294849867E271CDB899370ADF3